...
class UserExpensesFull extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get('/api/residence/user/', { headers: { Authorization: `Bearer ${auth.getToken()}` } })
      .then(res => {
              ...
              return <div key={index} >
                ...
                {split.paid_flag === false && <div className="level borderedLevel level-user">
                  <div className="level-item level-item-user has-text-centered">
                    <h5 className='mobileShow'>Residence:</h5>
                    <p>{split.expense.residence.short_name}</p>
                  </div>
                  <div className="level-item level-item-user has-text-centered">
                  ...
                  {split.user.id === user.id && <div className="level-item level-item-user has-text-centered">
                    <div>
...
export default UserExpensesFull